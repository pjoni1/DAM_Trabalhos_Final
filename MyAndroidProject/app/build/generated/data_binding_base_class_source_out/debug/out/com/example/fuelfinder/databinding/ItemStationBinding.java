...
public final class ItemStationBinding implements ViewBinding {
  ...
  private ItemStationBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvPrice,
      @NonNull TextView tvStationAddress, @NonNull TextView tvStationName) {
  ...
  public static ItemStationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemStationBinding((MaterialCardView) rootView, tvPrice, tvStationAddress,
          tvStationName);
    }
