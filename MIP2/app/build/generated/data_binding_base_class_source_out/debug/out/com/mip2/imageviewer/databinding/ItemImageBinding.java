...
package com.mip2.imageviewer.databinding;
...
public final class ItemImageBinding implements ViewBinding {
  ...
  private ItemImageBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView imageViewThumbnail, @NonNull TextView textViewTitle) {
  ...
  public static ItemImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemImageBinding((ConstraintLayout) rootView, imageViewThumbnail, textViewTitle);
    }
